  ...
  const workshopsData = [
     {
      ...
      img: imgRust,
      name: "Rust Workshop",
      wSpeakers: ["Devdutt Shenoi","Srihari Prasad","Advaith Narayanan","Alen P Varghese"],
      links: {
        facebook: "",
        instagram: "",
     ...
     {
      host: "NEST team",
      description: "NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons. NEST is an open source software and is licensed under the GNU General Public License.",
      img: imgNest,
      name: "NEST Workshop",
      ...
      <div className={styles.container}>
        {workshopsData &&
          workshopsData.map((workshop, index) => {
            return (
              <Speaker data={workshop} key={index} id={index} /> 
            ); 
          })}
    ...
    <div className={styles.card}>
      ...
      <div className={styles.events}>
        ...
        <div className={styles.links}>
          {workshop.links.web && (
            <a href={workshop.links.web} className={styles.link} target="_blank" rel="noopener noreferrer">
              <BsGlobe size={25} className={styles['link-icon']} />
            </a>
          )}
          {workshop.links.github && (
            <a href={workshop.links.github} className={styles.link} target="_blank" rel="noopener noreferrer">
      ...
      {/* Mobile description */}
      <p id={`description-${key}`} className={styles['description-mob']}>{workshop.description}</p>
    </div>
  )
}
